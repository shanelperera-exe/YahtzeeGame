...
int prioritize_upper_section(int dice[], int counts[], int computer_scores[], int computer_used_categories[], int total_upper_section_score);
int check_lower_section(int dice[], int computer_scores[], int computer_used_categories[], int counts[]);
...
int evaluate_high_priority_categories (int dice[], int computer_scores[], int computer_used_categories[], int counts[], int roll_count);
int evaluate_unscored_categories(int dice[], int computer_scores[], int computer_used_categories[], int counts[]);
int attempt_strong_category_scoring(int dice[], int computer_scores[], int computer_used_categories[], int counts[]);
